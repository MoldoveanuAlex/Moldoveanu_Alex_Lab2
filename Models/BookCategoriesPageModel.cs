...
namespace Moldoveanu_Alex_Laborator2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Moldoveanu_Alex_Laborator2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Moldoveanu_Alex_Laborator2Context context, string[] selectedCategories, Book bookToUpdate)
        {
